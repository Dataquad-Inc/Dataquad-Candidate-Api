...
//            }
    ...
    @Transactional
    public String sendJdToBenchCandidates(
        ...
        try {
            ...
            System.out.println("Bench IDs = "
                    + benchIds);

            // ==========================
            // FETCH REQUIREMENT
            // ==========================
            ResponseEntity<RequirementResponseDto> response =
                    requirementClient.getRequirementById(
                            requirementId
                    );
            ...
            RequirementResponseDto responseDto =
                    response.getBody();

            if (responseDto == null
                    || responseDto.getRequirement() == null) {
            ...
            RequirementResponseDto.Requirement requirement =
                    responseDto.getRequirement();
