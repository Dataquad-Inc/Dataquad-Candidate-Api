...
public class EmailService {
    ...
    public void sendBenchJdMail(
        ...
        try {
            ...
            helper.setSubject("New Job Opportunity - " + jobTitle);
            String htmlBody = "<html><body>" + "<h3>Hi "+ candidateName + ",</h3>"
            ...
            System.out.println("Attempting to send mail to: " + toEmail);
            mailSender.send(message);
            System.out.println("Mail sent successfully to: " + toEmail);

        } catch (Exception e) {
            System.out.println("Mail failed for: " + toEmail);
            e.printStackTrace();
